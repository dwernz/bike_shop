...
CREATE TABLE public.bikes (bike_id integer NOT NULL,
...
CREATE SEQUENCE public.bikes_bike_id_seq AS integer
...
CREATE TABLE public.rentals (rental_id integer NOT NULL,
...
CREATE SEQUENCE public.rentals_rental_id_seq AS integer
START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
SET DEFAULT nextval('public.bikes_bike_id_seq'::regclass);
...
SET DEFAULT nextval('public.rentals_rental_id_seq'::regclass);

--
-- Data for Name: bikes; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--
 COPY public.bikes (bike_id, type, size, available)
FROM stdin;

8 BMX 20 t 9 BMX 21 t 1 Mountain 27 t 2 Mountain 28 t 3 Mountain 29 t 4 Road 27 t 5 Road 28 t 6 Road 29 t 7 BMX 19 t \. --
-- Data for Name: customers; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--
 COPY public.customers (customer_id, phone, name)
FROM stdin;

1 555-5555 Me 2 000-0000 Test \. --
-- Data for Name: rentals; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--
 COPY public.rentals (rental_id, customer_id, bike_id, date_rented, date_returned)
FROM stdin;

1 1 1 2021-05-25 2023-01-18 2 1 2 2021-05-25 2023-01-18 3 1 3 2021-05-27 2023-01-18 4 1 4 2021-05-27 2023-01-18 5 1 5 2021-05-27 2023-01-18 6 2 6 2021-05-27 2023-01-18 7 2 7 2021-05-27 2023-01-18 \. --
...
ALTER TABLE ONLY public.bikes ADD CONSTRAINT bikes_pkey PRIMARY KEY (bike_id);
...
ALTER TABLE ONLY public.rentals ADD CONSTRAINT rentals_pkey PRIMARY KEY (rental_id);

--
-- Name: rentals rentals_bike_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.rentals ADD CONSTRAINT rentals_bike_id_fkey
FOREIGN KEY (bike_id) REFERENCES public.bikes(bike_id);

--
-- Name: rentals rentals_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.rentals ADD CONSTRAINT rentals_customer_id_fkey
